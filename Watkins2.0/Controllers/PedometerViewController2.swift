...
class PedometerViewController2: UIViewController {
    ...
    private var checkCounter = false
...
//            }
    ...
    @objc func play() {
        ...
        if musicCounter == 0 {
           ...
           helloWorldTimer = Timer.scheduledTimer(withTimeInterval: 0.75, repeats: true){ fakestep in
                // self.incrementcounter()
                self.runCount += 1
                self.stepCounter = Double(self.runCount)
                
//                print("complete distance \(self.completeDistance)")
//                print("step counter  \(self.stepCounter)")
//                print("goal distance  \(self.goalDistance)")
//                print("distance travel  \(self.distanceTravel)")

//                if self.completeDistance < 10{
//                    if self.runCount == self.completeDistance {
//                       // print("less thand part")
//                        fakestep.invalidate()
//                    }
//                }
                
                
//               else if self.completeDistance >= 10{
//                    if self.runCount == 11 {
//                        //                    self.stepCounter = Double(self.runCount) + self.stepCounter
//                        print(self.stepCounter)
//                       // print("greater thand part")
//
//                        fakestep.invalidate()
//
